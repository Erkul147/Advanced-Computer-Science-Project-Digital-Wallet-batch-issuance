...
public class PIDProvider extends TrustedEntity {
    ...
    public PIDProvider(String ID, String name,  String entityType, String issedDate, Boolean status, X509Certificate X509CertificateInfo, String levelOfAssurance) {
